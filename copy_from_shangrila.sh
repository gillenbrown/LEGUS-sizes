...
rsync -av --exclude '*drc.fits' --exclude '*sci.fits' --exclude '*tar.gz' --exclude '*bootstrapping*' gillenb@shangrila.astro.lsa.umich.edu:"/u/home/gillenb/code/mine/LEGUS-sizes/data/*" /Users/gillenb/code/legus_sizes/data/
