"""
mass_radius_legus_mw.py
- Fit the mass-size relation for all LEGUS clusters plus clusters from the MW
"""
import sys
...
funcs = [dummy_legus, mru_d.get_mw_open_clusters, mru_d.get_mw_ymc_krumholz_19_clusters]
