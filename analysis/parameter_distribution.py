...
axs[0].hist(big_catalog["central_surface_brightness_best"], bins=np.logspace(1, 8, 41))
axs[0].add_labels("Central Surface Brightness [e$^-$]", "Number of Clusters")
axs[0].set_limits(10, 1e8)
axs[0].set_xscale("log")

axs[1].hist(big_catalog["x_pix_single_fitted_best"], bin_size=500)
axs[1].add_labels("X Position [pixels]", "Number of Clusters")

axs[2].hist(big_catalog["x_pix_single_fitted_best"], bin_size=500)
